...
<div class="container">
    ...
    <form action="kupon_ekle_isle.php" method="POST">
        <label for="code">Kupon Kodu (Örn: HOSGELDIN20):</label>
        <input type="text" name="code" required>

        <label for="discount_rate">İndirim Oranı (% olarak, sadece sayı girin):</label>
        <input type="number" name="discount_rate" required>
